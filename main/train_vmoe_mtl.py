...
from main import trainer_utils
...
def main(_):
  ...
  gin.add_config_file_search_path('/home/yhy/code/ckfadamv_moe/ex_repo/vision_transformer/flaxformer/flaxformer/flaxformer/architectures/fido/example_configs/')
